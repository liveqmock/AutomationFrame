 ...
 * 文件名：StringUtils.java <br>
 * 版本信息：TODO <br>
 * 作者：赵增斌 E-mail：zhaozengbin@gmail.com QQ:4415599 weibo:http://weibo.com/zhaozengbin<br>
 * 日期：2013-6-21-下午4:58:01<br>
 ...
 * 
 * 类名称：StringUtils <br>
 * 类描述：提供字符串处理的实用方法集 <br>
 * 创建人：赵增斌 <br>
 * 修改人：赵增斌 <br>
 * 修改时间：2013-6-21 下午4:58:01 <br>
 * 修改备注：TODO <br>
 * 
 */
public class StringUtils {
	 ...
	 * 日期： 2013-6-21 下午5:01:34 <br>
	 */
	public StringUtils() {
	}

	/**
	 * 方法：escapeForIntro <br>
	 * 描述：特殊字符转换 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:01:46 <br>
	 * 
	 * @param string
	 * @return
	 */
	...
	/**
	 * 方法：getNotNullStr <br>
	 * 描述：得到非空的字符串，若字符串对象为null，则返回"" <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:02:32 <br>
	 * 
	 * @param objValue
	 *            Object待转换的原字符串对象
	 * @return 转换后字符串
	...
	/**
	 * 方法：getNotNullStr <br>
	 * 描述：得到非空的字符串，若字符串为null，则返回"" <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:02:57 <br>
	 * 
	 * @param strValue
	 *            待转换的原字符串
	 * @return 转换后字符串
	...
	/**
	 * 方法：ChineseStringToAscii <br>
	 * 描述：将中文转化成AscII码以便存入数据库 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:03:38 <br>
	 * 
	 * @param s
	 *            中文字符串
	 * @return 16进制字符串
	...
	/**
	 * 方法：ChineseStringToUTF <br>
	 * 描述：将UTF-8转化成AscII码以便存入数据库 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:04:27 <br>
	 * 
	 * @param s
	 *            中文字符串
	 * @return 16进制字符串
	...
	/**
	 * 方法：AsciiToChineseString <br>
	 * 描述：将AscII字符转换成汉字 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:04:43 <br>
	 * 
	 * @param s
	 *            ASCII字符串
	 * @return 汉字
	...
	/**
	 * 方法：regexReplace <br>
	 * 描述：使用正则表达式进行字符串内容替换 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:08:19 <br>
	 * 
	...
	/**
	 * 方法：exist <br>
	 * 描述：判断一个字符串中是否包含符合正则表达式定义的匹配条件的子串 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:09:06 <br>
	 * 
	 * @param regularExpression
	 *            正则表达式
	 * @param input
	 ...
	 */
	public static synchronized boolean exist(String regularExpression,
			String input) {
		Pattern pattern = Pattern.compile(regularExpression);
		Matcher matcher = pattern.matcher(input);
		return matcher.find();
	...
	/**
	 * 方法：fillZero <br>
	 * 描述：用"0"补足一个字符串到指定长度 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:09:33 <br>
	 * 
	 * @param str
	 *            源字符串
	 * @param size
	...
	/**
	 * 方法：getStrArryByString <br>
	 * 描述：根据字符串（文件类型或者多行输入类型）获取字符串数组 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:09:53 <br>
	 * 
	 * @param str1
	 *            输入字符串
	 * @return 返回结果
	...
	/**
	 * 方法：getStrWithSameElement <br>
	 * 描述：获得指定长度的字符串 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:11:43 <br>
	 * 
	 * @param num
	 * @param element
	 * @return
	...
	public static String getFillString(String strIn, int totalLength,
		...
		spaces = StringUtils.getStrSpace(spaceLength);
	...
	/**
	 * 方法：getStackTrace <br>
	 * 描述：以String类型返回错误抛出的堆栈信息 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:12:14 <br>
	 * 
	 * @param t
	 * @return
	 */
	...
	/**
	 * 方法：getStrByUpperFirstChar <br>
	 * 描述：转换字符串第一个字符为大写 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:12:27 <br>
	 * 
	 * @param str
	 * @return
	 */
	...
	/**
	 * 方法：getStrByLowerFirstChar <br>
	 * 描述：转换字符串第一个字符为小写 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:12:37 <br>
	 * 
	 * @param str
	 * @return
	 */
	...
	/**
	 * 方法：getStrToInt <br>
	 * 描述：通过字符串转换成相应的整型，并返回 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:12:43 <br>
	 * 
	 * @param strValue
	 *            待转换的字符串
	 * @return 转换完成的整型
	...
	/**
	 * 方法：getStrToDouble <br>
	 * 描述：通过字符串转换成相应的DOUBLE，并返回 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:13:11 <br>
	 * 
	 * @param strValue
	 *            待转换的字符串
	 * @return 转换完成的DOUBLE
	...
	/**
	 * 方法：getStrToShort <br>
	 * 描述：通过字符串转换成相应的短整型，并返回 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:13:30 <br>
	 * 
	 * @param strValue
	 *            待转换的字符串
	 * @return 转换完成的短整型
	...
	/**
	 * 方法：getStrToLong <br>
	 * 描述：通过字符串转换成相应的长整型，并返回 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:13:45 <br>
	 * 
	 * @param strValue
	 *            待转换的字符串
	 * @return 转换完成的长整型
	...
	/**
	 * 方法：toLengthForIntroduce <br>
	 * 描述：降字符串转换成给定长度的字符串，如超出的话截断，并在最后以两个点结尾 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:14:15 <br>
	 * 
	 * @param str
	 * @param length
	 * @return
	...
	/**
	 * 方法：toHtmlBack <br>
	 * 描述：函数后台使用中，请勿随便修改，不然会造成显示混乱(以前修改版本在下方注释中) <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:14:53 <br>
	 * 
	 * @param s
	 * @return
	 */
	 ...
	 */
	/**
	 * 方法：containsChinese <br>
	 * 描述：判断是否含有中文，如果含有中文返回ture <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:16:37 <br>
	 * 
	 * @param str
	 * @return
	...
	public static List<String> StringToList(String value, String exp) {
		...
		String[] vals = org.apache.commons.lang.StringUtils.split(value, exp);
		for (String val : vals) {
			resultList.add(val);
		}
		return resultList;
	...
	/**
	 * 方法：truncateStr <br>
	 * 描述：根据输入的长度截取字符串，单个单词超过输入长度的强制加换行 <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:18:30 <br>
	 * 
	 * @param str
	 *            输入的字符串
	 * @param len
	...
	/**
	 * 方法：unicodeToGB <br>
	 * 描述：编码转换，从unicode转换为GBK <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:19:08 <br>
	 * 
	 * @param l_S_Source
	 *            输入字符串
	 * @return str编码转换后的字符串
	...
	/**
	 * 方法：GBToUnicode <br>
	 * 描述：编码转换，从GBK转换为unicode <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:23:41 <br>
	 * 
	 * @param l_S_Source
	 *            输入字符串
	 * @return 编码转换后的字符串
	...
	private static org.apache.commons.lang.StringUtils instance = null;

	public static synchronized org.apache.commons.lang.StringUtils getInstance() {
		if (instance == null) {
			instance = new org.apache.commons.lang.StringUtils();
		}
		return instance;
	}

	/**
	 * 方法：trimContinuousSpace <br>
	 * 描述：将多个连续空格替换为一个,"a  b"-->"a b" <br>
	 * 作者：赵增斌 E-mail:zhaozengbin@gmail.com QQ:4415599
	 * weibo:http://weibo.com/zhaozengbin <br>
	 * 日期： 2013-6-21 下午5:26:22 <br>
	 * 
	 * @param src
	 * @return
	 */
	...
	public static String subStr(String content, Integer length, String padding)
			throws UnsupportedEncodingException {
		String str = "";
		int paddSize = org.apache.commons.lang.StringUtils.isBlank(padding) ? 0
				: padding.length();
		...
		if (org.apache.commons.lang.StringUtils.isNotBlank(padding)) {
			str += padding;
		}
		return str;
	}
