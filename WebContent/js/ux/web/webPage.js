$package('CEYND.webPage');
CEYND.webPage = function(){
	...
	var _this = {
				...
				toolbar:[
					...
					{id:'btnedit',text:'EditPage',btnType:'editPage',iconCls:'icon-edit',handler:function(){
							...
							if ( _box.utils.checkSelectOne(selected)){
								...
								CEYND.getById(_this.Action.getId,data,function(result){
									CEYND.closeProgress();//关闭缓冲条
		...
		saveTemp:function(){
			...
			if(_this.TempForm.form('validate')){
				...
				CEYND.saveForm(_this.TempForm,function(data){
					CEYND.closeProgress(); //关闭缓冲条
