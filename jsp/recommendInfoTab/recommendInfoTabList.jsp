...
<html>
  <head>
    <title>分类信息</title>
	<link type="text/css" rel="stylesheet" href="${e:basePath()}static/common/css/tips.css">
...
<body>
<center>
<form name="form1" method="post" action="${e:basePath()}/sys/recommendInfoTab/list.do">
	...
	<table class="maintable" border="0" width="98%" cellspacing="0">
		...
		<tr>
			<td colspan="4" align="center">
				<img src="${e:basePath()}static/sys/images/report/query.gif" class="query_btn" onclick="query()" style="cursor: pointer;">
			</td>
		</tr>
...
<table width="98%"  border="0" cellspacing="1" cellpadding="0" height="30">
    <tr>
        <td> <%-- 按钮--%>
		     <img src="${e:basePath()}static/sys/images/report/add.gif" class="add_btn" onclick="toAdd()" style="cursor: pointer;">&nbsp;
		     <img src="${e:basePath()}static/sys/images/report/delete.gif" class="delete_btn"  onclick="deletes()" style="cursor: pointer;">&nbsp;
		</td> 
		<%-- 分页面公共页面 --%>
...
<script type="text/javascript">
	function toAdd(){
		var _url = '${e:basePath()}sys/recommendInfoTab/toadd.do';
		YiYa.show(_url,'新增分类',450,250);
	}
	
	function toEdit(id){
		var _url = '${e:basePath()}sys/recommendInfoTab/toedit.do?id='+id;
	...
	function query(){
		...
		theform.action = '${e:basePath()}/sys/recommendInfoTab/list.do';
		YiYa.query(); 
	} 
	
	function deletes(){
		var theform = $("form:first")[0];
		theform.action = '${e:basePath()}sys/recommendInfoTab/deletes.do';
